...
///
/// A selection is not a fixed destination: it pairs with the app language
/// at prompt time (`targetInstructionOf`), and which of the two comes out
/// depends on the input text. Names are shown in their own language (the
/// norm for language pickers), so they are locale-invariant data, not
