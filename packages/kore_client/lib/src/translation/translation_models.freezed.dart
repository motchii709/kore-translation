...
mixin _$TranslationRequest {
 ...
 String get text; String get targetLanguage; ToneStyle get tone; String get explanationLanguage; bool get thinking;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is TranslationRequest&&(identical(other.text, text) || other.text == text)&&(identical(other.targetLanguage, targetLanguage) || other.targetLanguage == targetLanguage)&&(identical(other.tone, tone) || other.tone == tone)&&(identical(other.explanationLanguage, explanationLanguage) || other.explanationLanguage == explanationLanguage)&&(identical(other.thinking, thinking) || other.thinking == thinking));
}


@override
int get hashCode => Object.hash(runtimeType,text,targetLanguage,tone,explanationLanguage,thinking);

@override
String toString() {
  return 'TranslationRequest(text: $text, targetLanguage: $targetLanguage, tone: $tone, explanationLanguage: $explanationLanguage, thinking: $thinking)';
}
...
@useResult
$Res call({
 String text, String targetLanguage, ToneStyle tone, String explanationLanguage, bool thinking
});
...
/// Create a copy of TranslationRequest
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? text = null,Object? targetLanguage = null,Object? tone = null,Object? explanationLanguage = null,Object? thinking = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String text,  String targetLanguage,  ToneStyle tone,  String explanationLanguage,  bool thinking)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _TranslationRequest() when $default != null:
return $default(_that.text,_that.targetLanguage,_that.tone,_that.explanationLanguage,_that.thinking);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String text,  String targetLanguage,  ToneStyle tone,  String explanationLanguage,  bool thinking)  $default,) {final _that = this;
switch (_that) {
case _TranslationRequest():
return $default(_that.text,_that.targetLanguage,_that.tone,_that.explanationLanguage,_that.thinking);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String text,  String targetLanguage,  ToneStyle tone,  String explanationLanguage,  bool thinking)?  $default,) {final _that = this;
switch (_that) {
case _TranslationRequest() when $default != null:
return $default(_that.text,_that.targetLanguage,_that.tone,_that.explanationLanguage,_that.thinking);case _:
  return null;
...
class _TranslationRequest implements TranslationRequest {
  const _TranslationRequest({required this.text, required this.targetLanguage, this.tone = ToneStyle.auto, this.explanationLanguage = '日本語', this.thinking = true});
...
/// Create a copy of TranslationRequest
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? text = null,Object? targetLanguage = null,Object? tone = null,Object? explanationLanguage = null,Object? thinking = null,}) {
