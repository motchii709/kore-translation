...
Map<String, dynamic> _$DeepSeekConfigToJson(DeepSeekConfig instance) =>
    <String, dynamic>{
      'api_key': instance.apiKey,
      'base_url': instance.baseUrl,
      'model': instance.model,
...
AcpConfig _$AcpConfigFromJson(Map<String, dynamic> json) =>
    $checkedCreate('AcpConfig', json, ($checkedConvert) {
      final val = AcpConfig(
        command: $checkedConvert('command', (v) => v as String? ?? ''),
        $type: $checkedConvert('provider', (v) => v as String?),
      );
      return val;
    }, fieldKeyMap: const {r'$type': 'provider'});
...
CodexConfig _$CodexConfigFromJson(Map<String, dynamic> json) =>
    $checkedCreate('CodexConfig', json, ($checkedConvert) {
...
Map<String, dynamic> _$CodexConfigToJson(CodexConfig instance) =>
    <String, dynamic>{
      'command': instance.command,
      'model': instance.model,
      'provider': instance.$type,
