...
Map<String, dynamic> _$GeminiStreamChunkToJson(_GeminiStreamChunk instance) => <String, dynamic>{
    ...
    $checkedCreate('_GeminiCandidate', json, ($checkedConvert) {
      final val = _GeminiCandidate(
        content: $checkedConvert(
          'content',
          (v) => v == null ? null : GeminiContent.fromJson(v as Map<String, dynamic>),
        ),
      );
      return val;
    });

Map<String, dynamic> _$GeminiCandidateToJson(_GeminiCandidate instance) => <String, dynamic>{
    ...
    $checkedCreate('_GeminiContent', json, ($checkedConvert) {
      final val = _GeminiContent(
        parts: $checkedConvert(
          'parts',
          (v) => (v as List<dynamic>?)?.map((e) => GeminiPart.fromJson(e as Map<String, dynamic>)).toList() ?? const [],
        ),
      );
      return val;
    });

Map<String, dynamic> _$GeminiContentToJson(_GeminiContent instance) => <String, dynamic>{'parts': instance.parts};

_GeminiPart _$GeminiPartFromJson(Map<String, dynamic> json) => $checkedCreate('_GeminiPart', json, ($checkedConvert) {
...
Map<String, dynamic> _$GeminiPartToJson(_GeminiPart instance) => <String, dynamic>{
  'text': instance.text,
