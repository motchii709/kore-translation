        ...
        choices: $checkedConvert(
          ...
          (v) =>
              (v as List<dynamic>?)
                  ?.map(
                    (e) =>
                        DeepSeekChunkChoice.fromJson(e as Map<String, dynamic>),
                  )
                  .toList() ??
              const [],
        ),
...
Map<String, dynamic> _$DeepSeekChatChunkToJson(_DeepSeekChatChunk instance) =>
    ...
    $checkedCreate('_DeepSeekChunkChoice', json, ($checkedConvert) {
      final val = _DeepSeekChunkChoice(
        delta: $checkedConvert(
          ...
          (v) => v == null
              ? null
              : DeepSeekChunkDelta.fromJson(v as Map<String, dynamic>),
        ),
      );
      return val;
    });
...
_DeepSeekChunkDelta _$DeepSeekChunkDeltaFromJson(Map<String, dynamic> json) =>
    $checkedCreate(
      '_DeepSeekChunkDelta',
      json,
      ($checkedConvert) {
...
Map<String, dynamic> _$DeepSeekChunkDeltaToJson(_DeepSeekChunkDelta instance) =>
    <String, dynamic>{
