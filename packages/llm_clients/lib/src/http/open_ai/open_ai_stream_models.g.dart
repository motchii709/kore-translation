      ...
      final val = _OpenAiChatChunk(
        choices: $checkedConvert(
          ...
          (v) =>
              (v as List<dynamic>?)
                  ?.map(
                    (e) => OpenAiChunkChoice.fromJson(e as Map<String, dynamic>),
                  )
                  .toList() ??
              const [],
        ),
...
Map<String, dynamic> _$OpenAiChatChunkToJson(_OpenAiChatChunk instance) => <String, dynamic>{
    ...
    $checkedCreate('_OpenAiChunkChoice', json, ($checkedConvert) {
      final val = _OpenAiChunkChoice(
        delta: $checkedConvert(
          'delta',
          (v) => v == null ? null : OpenAiChunkDelta.fromJson(v as Map<String, dynamic>),
        ),
      );
      return val;
    });

Map<String, dynamic> _$OpenAiChunkChoiceToJson(_OpenAiChunkChoice instance) => <String, dynamic>{
...
Map<String, dynamic> _$OpenAiChunkDeltaToJson(_OpenAiChunkDelta instance) => <String, dynamic>{
